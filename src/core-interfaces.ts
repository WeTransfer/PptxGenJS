...
export type HyperLink = { rId: number; slide?: number; tooltip?: string; url?: string, hideUnderline?: boolean}
...
export interface ITextOpts extends PositionOptions, OptsDataOrPath, FontOptions {
	...
	break?: boolean
	breakLine?: boolean
	bullet?: boolean | { type?: string; code?: string; style?: string; startAt?: number; leftMargin?: number; fontFace?: string }
	charSpacing?: number
	color?: string
	fill?: ShapeFill
	glow?: IGlowOptions
